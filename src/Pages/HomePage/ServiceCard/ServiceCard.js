...
const ServiceCard = (props) => {
  ...
  const defaultImage ="./th.jpeg"; // You can replace this with any default image URL
    ...
    <div>
      <div className="overflow-hidden shadow-lg rounded-lg h-90 w-60 md:w-80 cursor-pointer m-auto">
        <div href="#" className="w-full block h-full">
          <img
            alt="blog"
            src={planDetails.image || defaultImage} // Use default image if planDetails.image is not available
            className="max-h-40 w-full object-cover"
          />
          <div className="bg-white dark:bg-gray-800 w-full p-4">
            <p className="text-green-500 text-md font-medium">
